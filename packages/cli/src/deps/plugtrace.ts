...
export const DEFAULT_PLUGTRACE_HINT =
  "Build PlugTrace locally, then set integrations.plugtrace.jar to e.g. ../pluglabs/plugtrace/plugtrace/paper-modern/build/libs/PlugTrace-0.2.1-SNAPSHOT.jar (or folia / bukkit-modern). PlugTrace is private — no Hangar/Modrinth fetch.";
