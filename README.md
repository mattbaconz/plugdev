...
| `plugdev config list\|open\|watch\|unwatch` | Edit live plugin configs |
...
The TUI has the same workflow under **Config files**. `Enter` opens a file and `Space` toggles reload-on-save.
...
**v0.12.7** — live plugin config editing and reload-on-save without rebuilding the JAR. See [CHANGELOG.md](CHANGELOG.md).
