...
**v1.0.2** — stable local Paper loop + live config UX. Update with `plugdev update` (or set `update.auto: true`). After 1.0, prefer additive `plugdev.yml` changes. See [CHANGELOG.md](CHANGELOG.md).
